...
def plotSFH(filepath, filename, EADir, hdu):
    ...
    if filename.startswith('sigma') or filename.startswith('comp'):
    ...
    if not filename.startswith('sigma') and not filename.startswith('comp'):
        timeVec = [10, 17, 25]
